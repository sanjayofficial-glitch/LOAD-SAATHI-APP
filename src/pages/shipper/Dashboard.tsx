...
const ShipperDashboard = () => {
  ...
  const { data: requests = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Fetch requests sent by this shipper
      ...
      // Fetch associated trips and truckers
    ...
    <div className="container mx-auto px-4 py-8 animate-in fade-in duration-500">
      <div className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-600 mt-2">Track your shipments and manage bookings</p>
        </div>
        {isLoading && (
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                Recent Requests
                <Link to="/shipper/my-shipments" className="text-sm font-normal text-orange-600 hover:underline">View All</Link>
              </CardTitle>
            </CardHeader>
            <CardContent>
              {requests.length === 0 ? (
